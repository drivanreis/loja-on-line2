...
<details>
  ...
  * Data para entrega final do projeto: `26/10/2023 23:59`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-035-project-frontend-online-store-ts.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-035-project-frontend-online-store-ts`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-035-project-frontend-online-store-ts/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-035-project-frontend-online-store-ts/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH35&template=betrybe/sd-035-project-frontend-online-store-ts)
